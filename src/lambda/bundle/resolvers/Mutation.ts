...
const promisifiedRandomBytes = util.promisify(randomBytes);
...
const promisifiedUpload: Function = util.promisify(
  cloudinary.uploader.unsigned_upload,
);
const promisifiedDestroy: Function = util.promisify(
...
const Mutations = {
  async register(parent: any, args: any, ctx: any, info: any) {
  ...
  //     });
  // },
  async login(parent: any, { username, password }: any, ctx: any, info: any) {
  ...
  logout(parent: any, args: any, ctx: any, info: any) {
    ctx.res.clearCookie('token');
    return { message: 'Goodbye' };
  },
  async requestReset(parent: any, { email }: any, ctx: any, info: any) {
  ...
  async resetPassword(parent: any, args: any, ctx: any, info: any) {
  ...
  async changePassword(parent: any, args: any, ctx: any, info: any) {
  ...
  async changeEmail(parent: any, args: any, ctx: any, info: any) {
  ...
  async updateRole(parent: any, args: any, ctx: any, info: any) {
    // Logged in?
    if (!ctx.req.userId) {
      throw new Error('User must be logged in');
    }
  ...
  async updateAccountType(parent: any, args: any, ctx: any, info: any) {
    // Logged in?
    if (!ctx.req.userId) {
      throw new Error('User must be logged in');
    }
  ...
  async updateAccountStatus(parent: any, args: any, ctx: any, info: any) {
    // Logged in?
    if (!ctx.req.userId) {
      throw new Error('User must be logged in');
    }
  ...
  async updateOffice(parent: any, args: any, ctx: any, info: any) {
    // Logged in?
    if (!ctx.req.userId) {
      throw new Error('User must be logged in');
    }
  ...
  async updateTitle(parent: any, args: any, ctx: any, info: any) {
    // Logged in?
    if (!ctx.req.userId) {
      throw new Error('User must be logged in');
    }
  ...
  async createEvent(parent: any, args: any, ctx: any, info: any) {
    // Logged in?
    if (!ctx.req.userId) {
      throw new Error('User must be logged in');
    }
  ...
  async updateEvent(parent: any, args: any, ctx: any, info: any) {
    // Logged in?
    if (!ctx.req.userId) {
      throw new Error('User must be logged in');
    }
  ...
  async setRSVP(parent: any, args: any, ctx: any, info: any) {
    // Logged in?
    if (!ctx.req.userId) {
      throw new Error('User must be logged in');
    }
    ...
    const userRSVP: any = currentUser.eventsRSVPd.find(
      (eventRSVP: any) => eventRSVP.event.id === rsvp.eventId,
    );
  ...
  async sendMessage(parent: any, args: any, ctx: any, info: any) {
    // Logged in?
    if (!ctx.req.userId) {
      throw new Error('User must be logged in');
    }
    ...
    if (
      ...
      // !to.some((subject: string): boolean => subject === emailGroups) &&
      to.length > 1
    ) {
    ...
    if (
      !to.includes('officers') ||
      !to.includes('webmaster')
    ...
    if (
      ...
      const peopleQueries = to
        .filter((recipient: string) => !emailGroups.includes(recipient))
        .map((person: any) => ({ username: person }));
      ...
      if (emails && emails.length > 1) {
        ...
        emailSettings.bcc = emails.map((email: any) => email.email);
      } else {
  ...
  async updateUserProfileSettings(parent: any, args: any, ctx: any, info: any) {
    // Logged in?
    if (!ctx.req.userId) {
      throw new Error('User must be logged in');
    }
  ...
  async updateAvatar(parent: any, args: any, ctx: any, info: any) {
    // Logged in?
    if (!ctx.req.userId) {
      throw new Error('User must be logged in');
    }
  ...
  async deleteAvatar(parent: any, args: any, ctx: any, info: any) {
    // Logged in?
    if (!ctx.req.userId) {
      throw new Error('User must be logged in');
    }
  ...
  async updateRig(parent: any, args: any, ctx: any, info: any) {
    // Logged in?
    if (!ctx.req.userId) {
      throw new Error('User must be logged in');
    }
    ...
    if (old) {
      try {
        const cloudinaryResults: any = await promisifiedDestroy(old.publicId);
  ...
  async deleteRig(parent: any, args: any, ctx: any, info: any) {
    // Logged in?
    if (!ctx.req.userId) {
      throw new Error('User must be logged in');
    }
  ...
  async updateVehicle(parent: any, args: any, ctx: any, info: any) {
    // Logged in?
    if (!ctx.req.userId) {
      throw new Error('User must be logged in');
    }
  ...
  async submitElection(parent: any, args: any, ctx: any, info: any) {
    // Logged in?
    if (!ctx.req.userId) {
      throw new Error('User must be logged in');
    }
  ...
  async submitVote(parent: any, args: any, ctx: any, info: any) {
    // Logged in?
    if (!ctx.req.userId) {
      throw new Error('User must be logged in');
    }
  ...
  async createTrail(parent: any, args: any, ctx: any, info: any) {
    // Logged in?
    if (!ctx.req.userId) {
      throw new Error('User must be logged in');
    }
  ...
  async updateTrail(parent: any, args: any, ctx: any, info: any) {
    // Logged in?
    if (!ctx.req.userId) {
      throw new Error('User must be logged in');
    }
